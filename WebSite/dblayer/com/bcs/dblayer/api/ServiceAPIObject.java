 ...
 */
public abstract class ServiceAPIObject {
    ...
    public abstract void start(String dbUrl, String dbUser, String dbPassword) throws APIException;
    
    public abstract void restart() throws APIException;
